...
export function calculateCountUntilDay(habit: HabitEntityWeekRpc, dayNumber: number): number {
...
export function getDayStatusCount(habit: HabitEntityWeekRpc, dayNumber: number): number {
